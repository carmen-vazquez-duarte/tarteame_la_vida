...
btnLeft.addEventListener("click", () => moveToLeftHandler());
btnRight.addEventListener("click", () => moveToRightHandler());// Add a click event listener to the right button

function moveToRightHandler() { // Function to move the carousel to the righ
